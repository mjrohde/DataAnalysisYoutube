...
def remove_stopwords(tokenized_comments):
    ...
    try:
        with open(f"{sys.path[0]}/cleaning/stopwords.txt", "r") as f:
            ...
            print("Custom stopwords file not found. Using NLTK stopwords only.")
    except Exception as e:
         print(f"An error occured while reading the custom stopwords file: {e}")
    ...
    filtered_comments = [
        [
            ...
            if token.strip() not in stopwords_set
        ]
